...
//
// This script is deliberately dumb. It does ONE thing on an explicit
// click — read the name and headline VISIBLE on the profile the user
// is already viewing, then open the Givin web app pre-filled. It never:
//   • crawls or reads connections
//   • runs network requests in the background
//   • sends messages or takes any action inside LinkedIn
// That keeps users' accounts safe and keeps you on the right side of
// LinkedIn's terms.
//
// The web app URL is set in config.js (window.GIVIN_WEB_URL).
// ─────────────────────────────────────────────────────────────

const WEB_URL = window.GIVIN_WEB_URL || "https://givin.app";
